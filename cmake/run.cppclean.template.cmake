...
SET( SUPPRESSIONS ${CPPCLEAN_SUPPRESSIONS} "'shared_ptr.h' does not need to be #included" "'ProfilerApp.h' does not need to be #included" )
...
# Run cppclean
EXECUTE_PROCESS( COMMAND ${CPPCLEAN} ${CPPCLEAN_OPTIONS} "${CPPCLEAN_SOURCE}" TIMEOUT "${CPPCLEAN_TIMEOUT}" OUTPUT_FILE "${CPPCLEAN_OUTPUT}" ERROR_FILE "${CPPCLEAN_ERROR}"
